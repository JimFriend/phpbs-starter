<?php
	...
	*/
	...
	function errorBlock($errors)
	{
		...
		{
			echo "<ul class='errorBlock'>";
			foreach($errors as $error)
			{
				echo "<li><span class='label label-danger'>Error</span>".$error."</li>";
			}
			echo "</ul>";
		}
	}
	...
	function messageBlock($messages)
	{
		...
		{
			echo "<ul class='messageBlock'>";
			foreach($messages as $message)
			{
				echo "<li><span class='label label-success'>Success</span>".$message."</li>";
			}
			echo "</ul>";
		}
	}
